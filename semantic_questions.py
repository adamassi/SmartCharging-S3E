...
# TODO UPdate the percentage of the battery
...
# done
    def is_damaged(self, battery):
        ...
        :param battery: Battery class instance
        """
        return battery.check_is_damaged()  # Assuming this method checks for physical damage
# done
...
# done
    def is_charger_free_for(self, battery):
        ...
        for geom in geoms_names:
            # print(geom)
            # Get the normal force applied by charger_geom on geom2.
